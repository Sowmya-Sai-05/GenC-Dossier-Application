...
import { MdEmail, MdLock, MdVisibility, MdVisibilityOff, MdArrowBack, MdError } from 'react-icons/md';
...
const Login = () => {
  ...
  useEffect(() => {
    ...
    else if (role === 'ROLE_TRAINEE') navigate('/trainee/dashboard');
    else if (role === 'ROLE_LEADER') navigate('/leader/dashboard');
  }, [role, navigate]);
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl shadow-indigo-200/40 ring-1 ring-gray-200/60 p-8 sm:p-10">
          ...
          <div className="flex flex-col items-center text-center mb-7">
            ...
            <span className="mt-3 inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-indigo-700 bg-indigo-100 border border-indigo-200 px-3 py-1 rounded-full">
              <HiSparkles className="text-indigo-500" /> Welcome back
            </span>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Admins, Leaders, and Trainees — same login.
            </p>
          </div>
